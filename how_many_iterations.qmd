...
Using the [optimized code](optimizing_code.qmd), we can easily explore how many Monte-Carlo iterations are necessary to get stable computational results: Simply re-run the same simulation with the same sample size! 
