...
# ToDo1: Simulation with simsem or lavaan package

# ToDo2: Add subchapter for SESOI instead of observed effect size

# ToDo3: Add bonus chapter on optimizing fit indices in SEM

# ToDo4: Link to Schoemann et al APP for mediation models
