...
-   [Generalized Linear Models](GLM.qmd)\
-   [Linear Mixed Models](LMM.qmd)\
-   [Structural Equation Modelling (SEM)](SEM.qmd)

The chapters on linear models should be worked through in this order, as they build upon each other.
