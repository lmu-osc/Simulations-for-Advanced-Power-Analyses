...
This book is still being developed. If you have comment to contribute to its improvement, you can submit pull requests in the respective .qmd file of the [source repository](https://github.com/MalikaIhle/Simulations-for-Advanced-Power-Analyses).
...
![](LMU-OSC_logo_small.jpg){fig-align="left" fig-alt="LMU-OSC green logo"}
...
-   [Linear Model I: a single dichotomous predictor](LM1.qmd)\
-   [Linear Model 2: Multiple predictors](LM2.qmd)\
-   #FIXME\
-   [Structural Equation Modelling (SEM)](SEM.qmd)
